                                                              ...
                                                              ZXIC_UINT16 key_word_offest, ZXIC_UINT8 key_word_length)
{
    ...
    ZXIC_COMM_PRINT("[%s] slot: %u vport: 0x%04x sdt_no: %u eram_index: %u rule_index: %u kw_off: %u kw_len: %u success.\n", \
                                              __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, eram_index, rule_index, \
...
static ZXIC_UINT32 dpp_pkt_capture_key_word_mode_table_delete(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 tcam_index)
{
    ...
    ZXIC_COMM_PRINT("[%s] slot: %u vport: 0x%04x sdt_no: %u eram_index: %u rule_index: %u success.\n", \
                                              __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, eram_index, rule_index);
...
ZXIC_UINT32 dpp_pkt_capture_item_insert(DPP_PF_INFO_T* pf_info, ZXDH_PKT_CAP_RULE *rule)
{
    ...
    ZXIC_COMM_PRINT("[%s] slot: %u vport: 0x%04x sdt_no: %u index: %u.\n",
                    __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, rule->tcam_index);
...
ZXIC_UINT32 dpp_pkt_capture_item_delete(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 tcam_index)
{
    ...
    ZXIC_COMM_PRINT("[%s] slot: %u vport: 0x%04x sdt_no: %u index: %u.\n",
                    __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, tcam_index);
...
ZXIC_UINT32 dpp_pkt_capture_table_dump(DPP_PF_INFO_T* pf_info, ZXDH_PKT_CAP_RULE *rule_array, ZXIC_UINT32 *entry_num)
{
    ...
    ZXIC_COMM_PRINT("[%s] slot: %u vport: 0x%04x sdt_no: %u pkt cap tcam table dump successed.\n",
...
ZXIC_UINT32 dpp_pkt_capture_speed_set(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 speed_kbps)
{
    ...
    ZXIC_COMM_PRINT("[%s] slot: %u vport: 0x%04x speed_kbps: %u.\n", \
                                              __FUNCTION__, pf_info->slot, pf_info->vport, speed_kbps);
