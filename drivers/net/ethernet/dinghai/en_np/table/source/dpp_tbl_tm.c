...
ZXIC_UINT32 dpp_tm_pport_dscp_map_table_set(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 port, ZXIC_UINT32 dscp_id, ZXIC_UINT32 up_id)
{
    ...
    ZXIC_COMM_TRACE_NOTICE("[%s] slot: %u vport: 0x%04x sdt_no: %u index: %u up_id: %u start.\n",
                                                    __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, index, up_id);
    ...
    ZXIC_COMM_TRACE_NOTICE("[%s] slot: %u vport: 0x%04x sdt_no: %u index: %u up_id: %u success.\n",
                                                    __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, index, up_id);
...
ZXIC_UINT32 dpp_tm_pport_up_map_table_set(DPP_PF_INFO_T* pf_info, ZXIC_UINT32 port, ZXIC_UINT32 up_id, ZXIC_UINT32 tc_id)
{
    ...
    ZXIC_COMM_TRACE_NOTICE("[%s] slot: %u vport: 0x%04x sdt_no: %u index: %u tc_id: %u start.\n",
                                                    __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, index, tc_id);
    ...
    ZXIC_COMM_TRACE_NOTICE("[%s] slot: %u vport: 0x%04x sdt_no: %u index: %u tc_id: %u success.\n",
                                                    __FUNCTION__, pf_info->slot, pf_info->vport, sdt_no, index, tc_id);
